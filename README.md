...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/calm-sky-2e7a
```

A live public deployment of this template is available at [https://calm-sky-2e7a.templates.workers.dev](https://calm-sky-2e7a.templates.workers.dev)
